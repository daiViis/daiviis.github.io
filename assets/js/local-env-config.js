...
// Only set config for local development (file:// protocol)
if (window.location.protocol === 'file:') {
    window.LOCAL_ENV_CONFIG = {
        ...
        SUPABASE_ANON_KEY: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNpdWxwYnhrd2Niem9zaGx6bXZiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTYyOTY4NTcsImV4cCI6MjA3MVg3Mjg1N30.UvoAL-i_Xv-h_OKfa8NN2CoClGBfQYHv1vNeu0elERo',
        
        // Netlify proxy URL (for proxy mode)
        NETLIFY_PROXY_URL: 'https://radiant-dodol-0c0bca.netlify.app'
    };
    console.log('🔧 Local environment config loaded for file:// protocol');
} else {
